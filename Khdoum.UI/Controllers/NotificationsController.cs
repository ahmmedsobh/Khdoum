...
namespace Khdoum.UI.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        {
            IEnumerable<Notification> Notifications = await NotificationsList();
            return Json(new
            {
        ...
        public async Task<IEnumerable<Notification>> NotificationsList()
        {
            IEnumerable<Notification> notifications = new List<Notification>();
            var Client = new HttpClient();
            var json = "";
            HttpResponseMessage response = await Client.GetAsync($"{Constant.BaseAddress}api/Notifications/GetNotificationsForUser");
        ...
        public async Task<IActionResult> Create(Notification notification)
        {
            if (ModelState.IsValid)
            {
                ...
                content.Add(new StringContent(users.ToString()), "Notifications");
